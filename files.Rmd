...
rename all files. (Note: Use of regular expressions with well named files makes renaming them a trivial task; e.g. sub(pattern = "(?=[[:digit:]]{2})", replacement = "0", x=test ,perl = TRUE) takes ##_Names to 0##_Names)
